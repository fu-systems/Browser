...
/* UTF-8 validation: now in browser_common.c */
...
/* Layout box position helper: now in browser_common.c */
...
/* URL resolution helper: now in browser_common.c */
...
/* Hit-testing and link ancestor: now in browser_common.c */
